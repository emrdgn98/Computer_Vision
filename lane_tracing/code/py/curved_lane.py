# -*- coding: utf-8 -*-
"""
Created on Sat Nov 27 22:17:49 2021
...
def canny(img):
    ...
    return canny
def pipeline2(img, s_thresh=(100, 255), sx_thresh=(15, 255)):
...
def display_lines(img,lines):
    ...
    if lines is not None:
        for line in lines:
            for x1, y1, x2, y2 in line:
                cv2.line(line_image,(x1,y1),(x2,y2),(255,200,0),30)
    
    inv_perspective = inv_perspective_warp(line_image)
    inv_perspective = cv2.addWeighted(img, 1, inv_perspective, 0.7, 0)
...
# img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB,(255,0,0))
# dst = pipeline(img)
# dst = perspective_warp(dst, dst_size=(1280,720))

# Visualize undistortion9
...
img_sonuc_1=vid_pipeline(img)
img_sonuc_2=vid_pipeline2(img)
...
f, (ax1, ax2) = plt.subplots(1, 2, figsize=(20,10))
ax1.imshow(img_sonuc_1)
ax1.set_title('Kavis Durumu Var', fontsize=30)
ax2.imshow(img_sonuc_2)
ax2.set_title('Kavis Durumu Yok', fontsize=30)



# cv2.imshow('l' ,dst*255)
# cv2.waitKey(0)